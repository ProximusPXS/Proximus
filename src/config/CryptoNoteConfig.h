...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 3167494;
        ...
        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3 = 60;
        ...
        /* TODO: Remove? */
        const uint64_t MINIMUM_FEE = UINT64_C(11);
        ...
        const uint32_t UPGRADE_HEIGHT_V4 = 400000; // Upgrade height for CN-Lite Variant 1 switch.

        const uint32_t UPGRADE_HEIGHT_V5 = 1000000; // Upgrade height for CN-Turtle Variant 2 switch.

        const uint32_t UPGRADE_HEIGHT_V6 = 1150000; // Upgrade height for Chukwa switch.
    ...
    const uint8_t BLOCK_MAJOR_VERSION_4 = 6; /* UPGRADE_HEIGHT_V4 */
    const uint8_t BLOCK_MAJOR_VERSION_5 = 7; /* UPGRADE_HEIGHT_V5 */
    const uint8_t BLOCK_MAJOR_VERSION_6 = 8; /* UPGRADE_HEIGHT_V6 */
    ...
    const int P2P_DEFAULT_PORT = 28087;

    const int RPC_DEFAULT_PORT = 28088;
    ...
    const char LATEST_VERSION_URL[] = "www.proximus-pxs.com";

    const std::string LICENSE_URL = "https://github.com/ProximusPXS/ProximusProject/blob/master/README.md";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {50, 0x58, 0x53, 0x53, 0x53, 0x50, 0x52, 0x4f, 0x58, 0x49, 0x4d, 0x55, 0x53, 0x20, 0x60}};

    const char *const SEED_NODES[] = {
     "3.22.167.181:28087", //Aleksandra Zjawiony 
     "18.218.207.157:28087" //Aleksandra Zjawiony
    };
} // namespace CryptoNote
