...
*   `git clone -b master --single-branch https://github.com/ProximusPXS/Proximus
*   `cd Proximus`
*   `mkdir build`
*   `cd build`
*   `cmake ..`
...
-   `cd ..`
-   `git clone https://github.com/ProximusPXS/Proximus
-   `mkdir -p Proximus/build`
-   `cd Proximus/build`
-   `cmake3 ..`
-   `make`
...
-   `cd <your_Proximus_directory>`
-   `mkdir build`
-   `cd build`
-   `cmake -G "Visual Studio 16 2019" -A x64 .. -DBOOST_ROOT=C:/local/boost_1_69_0`
-   `MSBuild Proximus.sln /p:Configuration=Release /p:PlatformToolset=v141 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild Proximus.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v141 /m`

The binaries will be in the `src/Release` folder when you are complete.

-   `cd src`
-   `cd Release`
-   `Proximusd.exe --version`

[^ Return To Top](#compiling-Proximus)
